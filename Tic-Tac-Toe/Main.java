...
// observer pattern - for future notification
interface IObserver{
...
// strategy pattern fof game rules
...
class StandardTicTacToeRules implements TicTacToeRules{
    @Override
    public boolean isValidMove(Board borad,int row,int col){
        return borad.isCellEmpty(row, col);
    }
